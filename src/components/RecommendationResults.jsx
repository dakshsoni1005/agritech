  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto animate-fade-in text-slate-800 dark:text-slate-100">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handlePrint}
          className="flex items-center space-x-2 text-sm font-bold text-white bg-bottlegreen hover:bg-bottlegreen-hover dark:bg-emerald-600 dark:hover:bg-emerald-500 px-4 py-2.5 rounded-xl transition-all duration-200 cursor-pointer shadow-md"
        >
