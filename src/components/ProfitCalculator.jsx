...
import { Calculator, FlaskConical, ShieldAlert, Sparkles, Receipt, Sprout, ArrowLeft } from 'lucide-react';

export default function ProfitCalculator({ lang, onBack }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-3xl p-6 shadow-md space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              {CROP_DATABASE.map((c) => (
                <option key={c.id} value={c.id} className="bg-white dark:bg-slate-955 text-bottlegreen dark:text-emerald-500">
