    ...
    <div className="relative max-w-md w-full mx-auto my-8">
      ...
      <div className="relative bg-white/95 dark:bg-slate-900/90 backdrop-blur-xl rounded-[2.5rem] border border-slate-100 dark:border-slate-800/80 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_50px_-12px_rgba(16,185,129,0.15)] p-8 sm:p-10 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center space-x-2 bg-bottlegreen hover:bg-bottlegreen-hover dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white dark:text-slate-955 py-3.5 px-4 rounded-2xl font-bold text-sm tracking-wide transition-all duration-200 shadow-lg hover:shadow-emerald-500/20 active:scale-[0.98] mt-6 cursor-pointer"
          >
